'''
filename: lead_scoring_data_pipeline.py
functions: build_dbs_task, load_data_into_db_task, raw_data_schema_check_task, map_city_tier_task, map_categorical_vars_task, interactions_mapping_task, model_input_schema_check_task
creator: Ashwini.Abhang
version: 1
'''
