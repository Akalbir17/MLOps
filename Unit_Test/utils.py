'''
filename: utils.py
functions: build_dbs, load_data_into_db, map_city_tier, map_categorical_vars, interactions_mapping
...
def load_data_into_db(db_path, db_file_name, data_directory):
    ...
    df_lead_scoring.to_sql(name='loaded_data_test_case', con=cnx, if_exists='replace',index=False)
