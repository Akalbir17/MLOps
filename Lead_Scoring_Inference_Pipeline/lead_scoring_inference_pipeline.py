'''
filename: lead_scoring_inference_pipeline.py
functions: encode_features_task, input_features_check_task, get_models_prediction_task, prediction_ratio_check_task, 
